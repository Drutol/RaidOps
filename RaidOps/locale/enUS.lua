...
L["#LabelTooltips:Hrs"] =  "How much time has this player spent Raiding.Tracked passively by Raid Sessions."
...
L["#wndSettings:PRPrec"] = "Set PR precision"
L["#wndSettings:EPGPPrec"] = "Set EP / GP precision"
...
L["#biddingStrings:EPGP"] = " [Chat Bidding] If you want to participate in an auction for item %s write %s in %s channel.Type !bid again to remove your bid."
...
L["#biddingStrings:short:EPGP"] = " [Chat Bidding] Item : %s , type %s to place your bet , type again to remove!"
--rev 147
...
--v2.25
L["#wndMain:DKPDecay:Title"] = "DKP Decay"
...
L["#wndEPGPSettings:ItemCost:FormulaStatic"] = "Item Cost = (slot value / quality) * "
L["#wndEPGPSettings:UnequipableCalc"] = "Calculate GP for unequippable items"
L["#wndEPGPSettings:ItemCost:Unequipable"] = "Unequippable"
